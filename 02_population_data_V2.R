...
pop <- read_excel("data/population_data/ukpopestimatesmid2020on2021geography.xlsx",
                sheet = "MYE 5",
                range = "A8:AR428")
...
pop_2021 <- read_excel("data/population_data/ukpopestimatesmid2021on2021geographyfinal.xlsx",
                       sheet = "MYE 5",
                       range = "A8:J428")
